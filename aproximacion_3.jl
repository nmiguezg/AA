...
function compararTopologias()
    ...
    topologys = [[3], [5], [2], [3,8], [3,4], [6,1], [4], [4,1], [3,2], [5,1]]
    ...
    Random.seed!(123);
    parameters = [
        Dict("kernel" => "poly", "kernelDegree" => 6, "kernelGamma" => 4, "C" => 1),
        Dict("kernel" => "poly", "kernelDegree" => 2, "kernelGamma" => 6, "C" => 10),
        Dict("kernel" => "poly", "kernelDegree" => 3, "kernelGamma" => 4, "C" => 10),
        Dict("kernel" => "rbf", "kernelDegree" => 0, "kernelGamma" => 5, "C" => 6), 
        Dict("kernel" => "rbf", "kernelDegree" => 0, "kernelGamma" => 2, "C" => 2), 
        Dict("kernel" => "rbf", "kernelDegree" => 0, "kernelGamma" => 1, "C" => 8), 
        Dict("kernel" => "linear", "kernelDegree" => 0, "kernelGamma" => "auto", "C" => 10),
